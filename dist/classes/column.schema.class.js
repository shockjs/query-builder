...
exports.ColumnSchema = undefined;
...
class ColumnSchema {
   ...
   */
  typecast(value) {
    if (value === '' && this.type !== _schema2.default.TYPE_TEXT && this.type !== _schema2.default.TYPE_STRING && this.type !== _schema2.default.TYPE_BINARY) {
      return null;
    }
